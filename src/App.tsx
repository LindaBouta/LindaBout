...
/******************************
 * GLOBAL VISITOR COUNTER (Netlify Function)
 ******************************/
...
export default function App() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Navbar only visible at the top of the page (scroll < 80px)
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900 font-sans">
      ...
      {/* NAVBAR (Logo + Visitor Counter on Mobile, Full Navbar on Desktop) */}
      <nav
      ...
      >
        ...
        {/* Center — Visitor Counter (mobile and desktop) */}
        {visitorCount !== null && (
          <div
        ...
        {/* Right — Navigation Links (only on desktop) */}
      ...
      <section id="services" className="relative z-10 py-24 px-4 text-center">
        ...
        {/* FOOTER (Glassy Like Navbar, Static) */}
